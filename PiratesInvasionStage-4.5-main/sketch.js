...
var broken_boat_sprite_data, broken_boat_spritesheet
...
function preload() {
  ...
  broken_boat_spritesheet = loadImage("assets/broken-ship-01.png")
  broken_boat_sprite_data = loadJSON("assets/broken-ship-01.json")
...
function setup() {
  ...
  var brokenBoatFrames = broken_boat_sprite_data.frames;
